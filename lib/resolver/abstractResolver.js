...
exports.AbstractResolver = function AbstractResolver() {
  ...
  this.getMapValue = function (map, field) {
    if (map.hasOwnProperty(field)) {
      ...
      if (value === null) {
        logger.info('AbstractResolver.getMapValue: Null value for ' + field + ' field');
      }

      return value;
    }

    logger.info('AbstractResolver.getMapValue: Unable to get value from map for ' + field + ' field');
    return null;
  };
