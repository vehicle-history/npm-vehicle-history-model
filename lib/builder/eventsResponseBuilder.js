...
exports.build = function (map, searchCarRequest, options, callback) {
  ...
  var events = [
    ...
    registrationEventBuilder.build('11-11-2011', true),
    deregistrationEventBuilder.build('11-11-2011', 'PETITION_EXPIRED'),
    inspectionEventBuilder.build('21-01-2013', '21-01-2014', null),
    inspectionEventBuilder.build('20-01-2014', '20-01-2015', 122000)
  ];
